...
// /\                                               \
// \_| 'F/C To C/F' - Convert Fahrenheit to Celsius |
//  | and vice versa.                              |
...
*/
/****************************************************************************/
/* Force no bound limit for min and max double in given temperature query. A */
/* bounds check seems redundant and you can't always correctly check and it */
/* seems interesting to test the bounds of the imagination of what a given  */
